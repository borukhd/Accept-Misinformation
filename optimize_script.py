...
models = [CR, FFTmax, FFTzigzag, S2MR, LP, RT, RH, RHlinear, PARTR, vanBavel, Hybrid, ]## 
...
for ident in set(persons):
    ...
    for index, row in data_for_pers.iterrows():
        ...
        for a in list(aux.keys()).copy():
            if a in ['Familiarity_All_Combined', 'Partisanship_All_Combined', 'Partisanship_Democrats_Combined', 'Partisanship_Republicans_Combined', 'truthful', 'crt', 'conservatism', 'ct','education', 'reaction_time', 'binaryResponse', 'accurate', 'Familiarity_Democrats_Combined', 'Familiarity_Republicans_Combined']:
...
features = ['id', 'task', 'sequence', 'choices', 'response_type', 'domain', 'response', 'truthful', 'binaryResponse', 'Familiarity_All_Combined', 'Familiarity_Party_Combined', 'Familiarity_Task', 'Partisanship_All_Combined', 'Partisanship_Party_Combined', 'conservatism', 'crt', 'ct', 'education', 'reaction_time'] + SentimentAnalyzer.relevant
